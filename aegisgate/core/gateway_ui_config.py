...
_UI_CONFIG_FIELDS: tuple[dict[str, object], ...] = (
    ...
    {
        "env": "AEGIS_ENABLE_DANGEROUS_RESPONSE_LOG",
    ...
    {
        "env": "AEGIS_DANGEROUS_RESPONSE_LOG_PATH",
    ...
    {
        "env": "AEGIS_ENABLE_LOCAL_PORT_ROUTING",
    ...
    {
        "env": "AEGIS_LOCAL_PORT_ROUTING_HOST",
    ...
    {
        "env": "AEGIS_ENABLE_RELAY_ENDPOINT",
    ...
    {
        "env": "AEGIS_ENABLE_EXACT_VALUE_REDACTION",
    ...
    {
        "env": "AEGIS_ENABLE_SYSTEM_PROMPT_GUARD",
