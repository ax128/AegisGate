...
_UI_CONFIG_FIELDS: tuple[dict[str, object], ...] = (
    ...
    {"env": "AEGIS_REQUIRE_CONFIRMATION_ON_BLOCK", "field": "require_confirmation_on_block", "label": "拦截需确认放行", "type": "bool", "section": "security"},
    {"env": "AEGIS_STRICT_COMMAND_BLOCK_ENABLED", "field": "strict_command_block_enabled", "label": "强制命令拦截", "type": "bool", "section": "security"},
    {"env": "AEGIS_CONFIRMATION_TTL_SECONDS", "field": "confirmation_ttl_seconds", "label": "确认超时（秒）", "type": "int", "section": "security"},
    {"env": "AEGIS_CONFIRMATION_EXECUTING_TIMEOUT_SECONDS", "field": "confirmation_executing_timeout_seconds", "label": "执行等待超时（秒）", "type": "int", "section": "security"},
    {"env": "AEGIS_CONFIRMATION_SHOW_HIT_PREVIEW", "field": "confirmation_show_hit_preview", "label": "确认文案显示命中片段", "type": "bool", "section": "security"},
    {"env": "AEGIS_PENDING_DATA_TTL_SECONDS", "field": "pending_data_ttl_seconds", "label": "Pending 数据保留（秒）", "type": "int", "section": "security"},
